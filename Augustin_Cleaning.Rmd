...
crime_spatial <- as.data.table(crime_data_with_areas[startsWith(as.character(crime_data_with_areas$CrimeDateTime),"2021/08"),])
...
Baltimore_map_2 <- tm_shape(baltimore) + tm_borders()+ tm_shape(Midtown_area) + tm_borders(lwd = 3,col = "red") + tm_layout(frame.lwd = 6,inner.margins = 0.05)
