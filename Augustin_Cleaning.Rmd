...
CrimeCateogryRepartition <- CrimePerCategoryPerArea %>% 
  group_by(Category) %>% 
...
FelonyStats <- mutate(FelonyStats,FelonyRatePerArea=FelonyStats$RepartitionPerCategoryPerArea/CrimeCateogryRepartition$Repartition[1]*100)
