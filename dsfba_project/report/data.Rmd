...
_Source of the data set:_ [https://data.baltimorecity.gov/datasets/bniajfi::percent-of-family-households-living-below-the-poverty-line-community-statistical-area/explore]
...
crime_data_with_areas <- crime_data_with_areas %>%  filter(CrimeDateTime >= as.Date("2000-01-01")) #We had 24 observations that dates back to before the year 2000 and 24 observation with no date. We only select crime committed after 2000 as the CCTV programm in baltimore started in 2000.
