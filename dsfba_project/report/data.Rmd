...
We have six raw data sets. All data sets were retrieved on Baltimore government's open data portal. We found data about crimes committed in Baltimore, CCTV location in the city and poverty rates. We also found a data set showing the reference boundaries of the Community Statistical Area geographies. The latter will certainly be helpful to match each data set's observations together.
...
```{r echo=TRUE}
Percent_of_Households_with_No_Internet_at_Home <- read_csv("data/Percent_of_Households_with_No_Internet_at_Home.csv")
```
