...
The idea is that we want the information about how crime evolved. Here we could have done a loop, but could not yet find a way to properly do it. We have created a data set for each year.
