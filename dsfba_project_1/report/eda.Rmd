...
The graph represent the monthly evolution of crime for each year. We see that there seems to be a sort of pattern and that, each year, crime increases mid-year before decreasing in winter.
...
tmap_animation(animated_crime_map, filename ="animated_crime_map.gif", delay=100)
