...
Violent_Crime_Yearly_evolution_map <- crime_data_with_areas %>%
  ...
  labs(title = str_wrap(("Overall, violent crime seems to have decreased for the 2017 to 2020 period"),width=70),x="Year",y="Violent crime occurences")
...
Property_Crime_Yearly_evolution_map <- crime_data_with_areas %>%
  ...
  ggplot(aes(year,n))+geom_line()+
  scale_x_date(limits = c(as.Date("2014-01-01"), as.Date("2020-12-31"))) +
  labs(title = str_wrap(("Overall, property crime seems to have decreased for the 2017 to 2020 period"),width=70),x="Year",y="Property crime occurences")
