...
We have seen that the level of poverty does not really seem to be a major determinant of CCTV density in an area. Therefore, we decided to construct a multiple regression model containing various variables. This enables us to see whether city officials make decisions regarding where to implement CCTVs based on, for example, socio-economic factors, educational factors or racial factors. We retrieved six new datasets on Baltimore's open data portal. The first one provides information about the percent of persons between the ages of 16 and 64 who are currently unemployed. The second one provides information about ... to be continued, I had to go to lunch - Augustin
...
Overall, it really seems that the main predictor of CCTV density that we could observe is violent crime. Racial metrics, educational metrics and socio economic indicators are quite poor predictors.
