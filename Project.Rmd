...
Augustin : Augustin obtained a degree in Business Administration at the University of St-Gallen where he had the opportunity to develop a strong interest in digital business ethics. He wrote his bachelor’s thesis on the privacy implications of the use of fear appeals in home surveillance devices’ marketing strategy.[COmment DW: Maybe add a personal interest/personal story]

Marine : Marine made a bachelor in Law at the UBO (Université de Bretagne-Occidentale). She is presently into the Master DCS (Droit, Criminalité et Sécurité des technologies de l'information) at the Unversity of Lausanne.Last year, she had the opportunity  to take a data protection course and learn more about cyber security and crime in general. [Comment DW: Maybe add a personal point, what makes you unique as a person, maybe a fun fact?]
...
Firstly, from our respective backgrounds, we derive a strong interest in new technologies and privacy. We believe that every person is entitled to the fundamental right to privacy, and thus privacy matters a lot to us. Unfortunately, one observes an increasing tendency of governments and other stakeholders (e.g. businesses such as GAFA (Google, Amazon, Facebook, Apple)) to take more and more control in our daily lives through digital technologies such as cameras, computers or smartphones. For these reasons it is interesting to ask ourselves if this massive collection of our data leads to more security or more restrictions of our freedoms. 
...
Thirdly, it must also be said that crime and the legislative discussions regarding the right to wear a gun in the United-States are fascinating. At first, it seems as if the freedom to carry a gun makes the US more prone to crimes such as mass shootings. To verify or falsify our hypotheses, we also want to see through these datasets, what kind of crime prevails in American cities and how it evolves according to the districts and their particularities.  

Fourthly, we also find that studying this dataset on security camera placement is a good approach to answer these questions. Here are some interesting articles that guided us in our research : 
...
In a world where CCTVs and other surveillance systems are flourishing, it might be beneficial to take a step back and question both the efficacy and the implementation design of such technologies often portrayed as miraculous solutions to very complex issues.
...
CAM_NUM = ???? honestly don't what it is, it might be the actual number of the cam and this might imply that not all cameras installed are present in the dataset

LOCATION = Textual information on where the crime was committed 

PROJ = ???? Again, it seems to be information about the neighbourhood but it hardly ever matches "standard" neighbourhood names
