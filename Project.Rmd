...
CAM_NUM = Unique number attributed to the camera. This might suggest that the dataset does not show the location of every camera in Baltimore [What about the many zeros?]
...
[Comment DW: What about the installment date? DO we have this information somewhere?]
