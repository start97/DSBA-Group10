...
To combine the areas and the crime location in our datasets, we use firstly use the mutate()-function to create a new column with lower case letters in the crime dataset. In the meanwhile we needed a clean area file, in which we use the seperate()-function to create a dataset in which eight neighborhoods are assigned to an areas.
